...
FitModel <- function(phyloseq,
  ...
  replicate_var <- "Replicate"  # assumed lowest-level random effect
  
  # Step 2: Relevel OTU to most abundant as reference
  ...
  # Step 3: Optional - clean treatment levels
  ...
  # Step 4: Build model formulas with species interaction (except lower-level)
